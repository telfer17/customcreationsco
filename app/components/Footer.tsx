    ...
    <footer className='p-4 bg-black '>
      <div className='flex flex-wrap items-start justify-between gap-20 max-lg:flex-col'>
        <div className='flex flex-col items-start'>
          <Link href='/'></Link>
          <Image src={headerLogo} alt='Header logo' width={200} height={100} />
        </div>
      </div>

      <div className='flex flex-wrap flex-1 gap-20 justify-evenly lg:gap'>
      ...
      <div className='flex justify-between mt-24 text-gray-200 max-sm:flex-col max-sm:items-center'>
